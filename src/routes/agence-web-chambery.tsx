    ...
    <main className="min-h-screen border-t border-white/5">
      <section className="relative overflow-hidden bg-hero py-20">
        ...
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="mx-auto mt-6 max-w-3xl text-balance text-4xl font-bold leading-tight md:text-6xl">
            Création de site web à <span className="text-gradient">Chambéry</span>
          </h1>
      ...
      <section className="border-t border-white/5 py-20">
        <div className="mx-auto grid max-w-5xl gap-10 px-6 md:grid-cols-2">
          <div>
            <h2 className="text-2xl font-bold">Pour être choisi, il faut d’abord être trouvé.</h2>
            <p className="mt-4 text-muted-foreground">
              L’objectif : une page Chambéry qui ranke, rassure, et envoie vers un CTA audit clair.
            </p>
          </div>
          <div className="rounded-2xl border border-white/5 bg-card/50 p-6 shadow-card">
            <h3 className="text-base font-semibold">Ce que je mets en place</h3>
            <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
              <li>• Message clair en 5 secondes + CTA</li>
              <li>• Preuves (portfolio) + éléments de confiance</li>
              <li>• Bases SEO locales (structure, perf, contenu)</li>
            </ul>
          </div>
        </div>
      </section>
