...
import {
  ArrowRight, Mail, Phone, MapPin, Instagram, Facebook, Linkedin, Music2, MessageCircle, HeartHandshake,
} from "lucide-react";
      ...
      <SnapPage>
        ...
        <SnapSection id="canaux" className="flex items-center border-t border-white/5 py-16">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3 rounded-2xl border border-white/10 bg-card/20 p-5">
            <span className="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">Sur les réseaux</span>
            {SOCIALS.map((s) => (
              <a
                key={s.label}
                href={s.href}
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl border border-white/10 bg-card/20 p-6 shadow-card">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                J’accompagne mes clients partout en France (visio, téléphone, email). Une rencontre en Savoie est
            ...
            >
              ...
              <div className="text-sm font-semibold text-foreground">Ou écrivez-moi directement</div>
              ...
              <label className="block">
                <span className="text-xs font-semibold text-muted-foreground">Téléphone (optionnel)</span>
                <input
                  name="telephone"
                  type="tel"
                  className="mt-1.5 w-full rounded-md border border-white/10 bg-background/50 px-3 py-2.5 text-sm text-foreground outline-none focus:border-white/20"
