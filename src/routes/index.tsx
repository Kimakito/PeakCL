  ...
  return (
    <section id="avis" className="relative flex w-full items-center overflow-hidden py-16 md:py-20">
      ...
      <div className="mx-auto w-full max-w-7xl px-8 md:px-16">
        ...
        {/* Grille et non plus bandeau defilant : les six avis se lisent
            simultanement, on peut revenir sur une phrase, et rien ne bouge
            pendant la lecture. */}
        <TestimonialWall testimonials={peakclTestimonials} />
      </div>
    </section>
  );
}
  ...
  return (
    <section aria-label="Réassurance" className="border-y border-border bg-card/30 py-4">
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-center gap-x-8 gap-y-2 px-6 text-sm">
        <Stat target={DELIVERED_COUNT} label="projets clients livrés" />
