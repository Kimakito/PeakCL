...
export const Route = createFileRoute("/cadrage/veronique/merci")({
  head: () => ({
    meta: [
      { title: "Questionnaire envoyé · PeakCL" },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:url", content: absUrl("/cadrage/veronique/merci") },
    ],
  }),
  component: MerciCadrageVeroniquePage,
});

function MerciCadrageVeroniquePage() {
  return (
