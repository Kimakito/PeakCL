...
export const Route = createFileRoute("/merci-diagnostic")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: absUrl("/merci-diagnostic") },
    ],
    links: [{ rel: "canonical", href: absUrl("/merci-diagnostic") }],
  }),
  component: MerciDiagnosticPage,
});
      ...
      <section className="relative overflow-hidden bg-hero py-24">
        ...
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            J’ai bien reçu votre diagnostic. Je le lis et je reviens vers vous avec une
            recommandation claire pour améliorer votre présence en ligne.
          </p>
